# Dscharwiss — microWakeWord model
Downloaded from https://microwakeword.com

## What's in this ZIP
  dscharwiss.tflite    — TFLite model (the trained wake word)
  dscharwiss.json      — ESPHome manifest (points at the .tflite)

Keep both files together. The manifest references the .tflite
by relative path (./dscharwiss.tflite); renaming or separating them
...
## Tuning
Open dscharwiss.json and edit the "micro" section:

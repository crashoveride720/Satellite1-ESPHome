# Oracle — microWakeWord model
Downloaded from https://microwakeword.com

## What's in this ZIP
  oracle.tflite    — TFLite model (the trained wake word)
  oracle.json      — ESPHome manifest (points at the .tflite)

Keep both files together. The manifest references the .tflite
by relative path (./oracle.tflite); renaming or separating them

# Phoenix — microWakeWord model
Downloaded from https://microwakeword.com

## What's in this ZIP
  phoenix.tflite    — TFLite model (the trained wake word)
  phoenix.json      — ESPHome manifest (points at the .tflite)

Keep both files together. The manifest references the .tflite
by relative path (./phoenix.tflite); renaming or separating them

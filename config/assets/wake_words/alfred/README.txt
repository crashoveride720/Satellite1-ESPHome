# Alfred — microWakeWord model
Downloaded from https://microwakeword.com

## What's in this ZIP
  alfred.tflite    — TFLite model (the trained wake word)
  alfred.json      — ESPHome manifest (points at the .tflite)

Keep both files together. The manifest references the .tflite
by relative path (./alfred.tflite); renaming or separating them
